...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container tect-center">
            ...
            <div class="col-4">
                <div class="highlighted-kategori kategori-baju-pria"></div>

            </div>

            <div class="col-4">
                <div class="highlighted-kategori kategori-baju-wanita"></div>
            </div>

            <div class="col-4">
                <div class="highlighted-kategori kategori-baju-anak-anak"></div>
            </div>
